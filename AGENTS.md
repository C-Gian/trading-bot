...
Checkpoint 1 (synthetic/causal implementation) is executor-complete; the current task is the
review-only `RESEARCH-DIRECTOR-REVIEW-SYSTEM-G1-CHECKPOINT-1` and executor market work is forbidden.
