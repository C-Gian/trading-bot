"""Freeze the cross-asset search plan, both preregistrations and the admission.

This runs after the source audit has passed and before any Stage-3 cross-asset
...
def main() -> None:
    ...
    print(
        f"predictive stage 3 cross asset breadth frozen: status={record['status']} "
