...
def test_wp009_fixed_scope_and_non_trial_accounting() -> None:
    ...
    # WP-009 itself consumed no strategy trial. WP-011 later advanced these cumulative
    # totals; the WP-009 scope assertions above are what this test actually guards.
    ...
    assert totals["supervised_model_fits"] == 156
