...
def test_wp009_fixed_scope_and_non_trial_accounting() -> None:
    ...
    # WP-009 itself consumed no strategy trial. WP-011 through WP-013 later advanced these
    ...
    assert totals["configuration_variants"] == 21
    assert totals["profile_trials"] == 101
    assert totals["supervised_model_fits"] == 186
